     ...
     <div class="flag-div">
         <div class="flag-div-inner">
             <a href="?language=eng.php"><img src="img/UnionFlag.png" alt="British flag used to change language"
                     onclick="location.reload();" id="flag" alt="" /></a>
         </div>
         <div class="flag-div-inner">
             <a href="?language=esp.php"><img src="img/spain-flag.png" alt="Spanish flag used to change language"
                     onclick="location.reload();" id="flag" alt="" /></a>
         </div>
         <div class="flag-div-inner">
             <a href="?language=cat.php"><img src="img/catalan-flag.png" alt="Catalan flag used to change language"
                     onclick="location.reload();" id="flag" alt="" /></a>
         </div>
     </div>
         ...
         <div id="top1" class="top1" name="top1">
             ...
             <div class="left1">
                 ...
                 <form id="form-id" class="form-class" method="post" action="contact-form-process.php">
                     ...
                     <div class="form-group">
                         <button type="submit" id="button" class="btn btn-primary btn-lg btn-block">Envia
                             Missatge</button>
                     </div>
                 </form>
