...
<body>
    ...
    <button class="toggleButton" id="toggleButton">Show Chat</button>
    ...
    <div id="toggleText" style="display: none;">
        ...
        <div class="form-container">
            <form method="post" action="indexnew.php" style="margin-bottom: 10px;">
    ...
    window.addEventListener('DOMContentLoaded', function() {
        ...
        // Use PHP to check if the chat window should be open
        const chatOpen =
            <?php echo isset($_SESSION['chatOpen']) && $_SESSION['chatOpen'] ? 'true' : 'false'; ?>;
        ...
        // Optionally, you can also scroll to the bottom every time a new message is added dynamically (if needed)
    });
    </script>
    <script>
